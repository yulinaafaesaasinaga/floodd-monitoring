 ...
 * Kirim telemetri ke Laravel: POST /api/ingest + header X-API-KEY.
 * Perintah dari dashboard: GET /api/command/get + POST /api/command/done (sama API key).
 *
 * Salin ke Arduino IDE, set board ESP32 Dev Module.
 */
#include <Wire.h>
...
/** Ambil satu perintah pending dari Laravel (dashboard manual). */
